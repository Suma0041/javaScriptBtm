//console.log('hello javascript and nodejs');//it is used for debugging purpose
...
//document.body.innerText="<h1>hello inner text</h1>";
...
//document.write("my name is"+name+"my aage is"+age+"i work for"+company+"salary"+salary);
